  ...
  return (
    <main className="min-h-screen bg-[#f3f0e7] text-slate-900" data-print-root>
      ...
      <div className="mx-auto flex max-w-[210mm] flex-col gap-6 px-4 py-6 print:px-0 print:py-0">
        <section className="print-sheet overflow-hidden bg-white shadow-[0_25px_80px_rgba(15,23,42,0.08)]">
          <div className="relative border-b border-black/10 bg-[#111111] px-8 py-12 text-white">
          ...
          <div className="grid gap-8 px-8 py-8 md:grid-cols-[1.15fr_0.85fr]">
            <div>
        ...
        <section className="print-sheet print-page-break bg-white shadow-[0_25px_80px_rgba(15,23,42,0.08)]">
                ...
                <div className="mt-4 space-y-4">
                  {conquistas.timeline.slice(0, 4).map((item) => (
                    <div key={`${item.year}-${item.title}`} className="border-l-2 border-[#d0aa50] pl-4">
                      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#8a6a21]">{item.year}</p>
                ...
                <div className="mt-5 space-y-4">
                  {roadmap.phases.map((phase) => (
                    <div key={phase.period} className="rounded-2xl bg-slate-50 p-4">
                      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#8a6a21]">{phase.period}</p>
